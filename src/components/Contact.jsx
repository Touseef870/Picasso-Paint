...
function Contact() {
    return (
        <div className="p-8 w-7xl">
            <div className="grid lg:grid-cols-2 items-start gap-12 p-2 mx-auto max-w-7xl max-lg:max-w-2xl bg-white  rounded-md">
                <div>
                    <h2 className="text-slate-900 text-3xl font-bold">Let's Talk</h2>
                    <p className="text-[15px] text-slate-600 mt-4 leading-relaxed">
                        Email us with any questions or inquiries or call 0331-PICASSO (7422776).

                        We would be happy to answer your questions and set up a meeting with you. what can we help you ?
                    </p>
                    <div className="mt-8">
                    ...
                    <div className="mt-6">
                        <h2 className="text-slate-900 text-base font-semibold">Phone</h2>
                        <ul className="mt-4">
                            <li className="flex items-center">
                                <div className="bg-gray-200 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                                    <Phone />
                ...
                <form className="space-y-4">
                    ...
                    <button
                        type="button"
                        className="text-white bg-[#BB2429] hover:bg-[#ff6369] rounded-md text-sm font-medium px-4 py-2.5 w-full cursor-pointer border-0 mt-2"
                    >
                        Send message
                    </button>
                </form>
